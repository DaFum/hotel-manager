/**
 * Records the non-empty current-format save fixture from a real game.
 *
 * A fixture written by hand only proves the shape its author imagined. This
 * one is the state of an actual group — a second
...
send({
  ...
  name: "Hanau Park",
  cityId: simulation.state.hotel.cityId,
  rooms: 60,
...
// is exactly the state a save round trip is most likely to lose.
send({ type: "ORDER_SUPPLIES", sku: "breakfast-portion", quantity: 200 });
