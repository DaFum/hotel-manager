export const de = {
  ...
  reputation: {
    cause: {
      ...
      "annual leave approved": "Jahresurlaub genehmigt",
      "promotion granted": "Beförderung erteilt",
      "severe energy outage": "Schwerer Energieausfall",
      "severe water outage": "Schwerer Wasserausfall",
      "power outage": "Stromausfall",
      "water outage": "Wasserausfall",
      "grid outage": "Netzausfall",
      "staff strike": "Streik des Personals",
      "labor dispute": "Arbeitskampf",
      trainingCompleted: "Schulung abgeschlossen: {course}",
      resignation: "Kündigung durch Mitarbeiter: {reason}",
      dismissal: "Entlassung: {reason}",
      outageDetailed: "{kind}-Ausfall: {reason} ({minutes} Min.)",
