...
export const ENGLISH_TEXT = {
  ...
  "campaign.sandbox": "Sandbox options",
  "campaign.sandbox.economicVolatilityBasisPoints": "Economic volatility",
  "campaign.sandbox.crisisFrequencyBasisPoints": "Crisis frequency",
  "campaign.sandbox.competitorAggressionBasisPoints": "Competitor aggression",
  "campaign.sandbox.startingCapitalBasisPoints": "Sandbox starting capital",
  "campaign.sandbox.technologySpeedBasisPoints": "Technology speed",
  "campaign.sandbox.constructionVolatilityBasisPoints":
    "Construction volatility",
  "campaign.sandbox.informationAccuracyBasisPoints": "Information accuracy",
